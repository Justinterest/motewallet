...
// AgreeListReq is the request body for POST /rest/v2.0/customer/agreeList.
// See: https://opendocs.kun.global/docs/api/sub-merchant-pending-agreement-query
...
// AgreementList accepts either a JSON array or {"list":[...]} from KUN.
